        ...
        <div class="container-fluid">
            ...
            <ul class="header-nav ms-3">
                <li class="nav-item dropdown"><a class="nav-link py-0" data-coreui-toggle="dropdown" href="#"
                    ...
                    <div class="avatar avatar-md"><img class="avatar-img" src="/assets/coreui/img/avatars/8.jpg"
                    ...
                    <div class="dropdown-menu dropdown-menu-end pt-0">
                        ...
                        <a class="dropdown-item" href="">
                            ...
                            Updates<span class="badge badge-sm bg-info ms-2">1</span></a><a class="dropdown-item"
                                                                                            href="">
                        <svg class="icon me-2">
                            <use xlink:href="/vendors/coreui/@coreui/icons/svg/free.svg#cil-envelope-open"></use>
                        </svg>
                        Messages<span class="badge badge-sm bg-success ms-2">2</span></a><a class="dropdown-item"
                                                                                            href="">
                        <svg class="icon me-2">
                            <use xlink:href="/vendors/coreui/@coreui/icons/svg/free.svg#cil-task"></use>
                        </svg>
                        Tasks<span class="badge badge-sm bg-danger ms-2">3</span></a><a class="dropdown-item" href="">
                        <svg class="icon me-2">
                            <use xlink:href="/vendors/coreui/@coreui/icons/svg/free.svg#cil-comment-square"></use>
                        </svg>
                        Comments<span class="badge badge-sm bg-warning ms-2">4</span></a>
                        <div class="dropdown-header bg-light py-2">
                        ...
                        Payments<span class="badge badge-sm bg-secondary ms-2">5</span></a><a class="dropdown-item"
                                                                                              href="">
                        <svg class="icon me-2">
                            <use xlink:href="/vendors/coreui/@coreui/icons/svg/free.svg#cil-file"></use>
                        </svg>
                        Projects<span class="badge badge-sm bg-primary ms-2">6</span></a>
        ...
        <main>
            <div class="container-fluid px-4">
                ...
                <form action="/write" method="post" enctype="multipart/form-data" style="height: 500px">
                    제목<input id="title" type="text" name="title" value="${bd.title}" disabled>
                    작성자<input type="text" name="writer" value="${bd.writer}" disabled>
                    작성일<input type="text" name="writetime" value="${bd.write_time}" disabled>
                    <br><br>
                    내용<textarea name="content" id="editor" readonly="true">${bd.content}</textarea>
                </form>
            </div>
            <c:if test="${not empty fno}">
            <div class="mb-3">
                <label class="form-label">첨부파일</label>
                <a href="/filedown?no=${fno}">다운로드</a>
            </div>
            </c:if>

            <button class="btn btn-lg btn-outline-light mt-3" type="button" onclick="location.href='/board'"
                    style="background-color: gray">뒤로가기
            </button>
